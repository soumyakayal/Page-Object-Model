...
import com.relevantcodes.extentreports.ExtentReports;
	...
	*/
	...
	public class Audience_Builder_UI_Geography_Targeting_DMA extends TestBase{
	...
	System.out.println("Start the 'Audience_Builder_UI_DMA' automation script in the UAT platform of the AdTheorent");	

	System.out.println("The objective of the Test is to validate the Audience_Builder_UI_Geography_Targeting_DMA section in the Geography Targeting interface");	
	...
	extent = new ExtentReports (System.getProperty("user.dir") +"/test-output/Audience_Builder_UI_Geography_Targeting_DMA.html", true);
	...
	public static String getScreenshot(WebDriver driver, String screenshotName) throws Exception {
		...
		return destination;
		  ...
		  public Object[][] credentials() throws BiffException, IOException {
			...
			/* String home = System.getProperty("user.home");
			 File f = new File(FileNameUtils.normalize(home + "/Desktop/Selenium/TestData.xls"));	*/		 
			  ...
			  File f = new File("TestData/Audience_Builder_UI_DMA.xls");
		 ...
		 for (int i=1; i<rows; i++){
			 ...
			 public void Navigate_To_Audience_Builder_UI_MANAGE_REAL_TIME_AUDIENCES_panel(String sUsername, String sPassword, String audiencename, String search_city_1, String search_city_2, String append, String replace) throws Exception  {  
			 ...
			 public void Audience_Builder_UI_DMA_Chosen_No_Data_Append(String sUsername, String sPassword, String audiencename, String search_city_1, String search_city_2,String append, String replace) throws Exception  {  
		    	 		
				 
				 
				 logger = extent.startTest("Audience_Builder_UI_DMA_Chosen_No_Data_Append");		
		    		      ...
		    		      Thread.sleep(6000);
							...
							driver.findElement(By.xpath(".//*[@id='divGeographySummary']")).click();
						      ...
						      Thread.sleep(6000); 
					            ...
					            System.out.println("Selecting the DMA option from the Geography Targeting interface");


						      WebElement ele = driver.findElement(By.xpath("//li//a[@onclick='GetDmaData()' and text()='DMA']"));
					            ...
					            System.out.println("Successfully navigated to DMA interface");

				    		      Thread.sleep(8000);   
				    		      
							    System.out.println("****************************************************************************************");

								System.out.println("Clicking on Download Full List button");

								driver.findElement(By.id("lnkDownloadFullList")).click();

								Thread.sleep(9000); 

								System.out.println("DMA List is successfully downloaded");
				    		      
								Thread.sleep(8000);   
				    		      
/*				    		        System.out.println("Clicking on Remove All button");
*/
									driver.findElement(By.cssSelector("#dma > div.row > div.col-sm-2.text-center.multiselect-controls > p:nth-child(3) > a > i")).click();

									Thread.sleep(4000);

/*				    		        System.out.println("DMA options are successfully moved into the Available section");
*/
									System.out.println("***************************************************************************************"); 

									System.out.println("Performing Append operation");

			                 		driver.findElement(By.id("dvDMAUploadType")).click();
		    		    			
		    		    			Thread.sleep(7000);
		    		    					
		    		                List<WebElement> dropdown4=driver.findElements(By.xpath("//div[@id='dvDMAUploadType']/ul//li"));
		    		    			
		    		    			int totaloptions4= dropdown4.size();
		    		    			
		    		    			for (int i=0;i<totaloptions4;i++)
		    		    				
		    		    			{
		    		    				
		    		    				String option4=dropdown4.get(i).getText();
		    		    				
		    		    				if(option4.equalsIgnoreCase(append))
		    		    				{
								...
								String msgText =driver.findElement(By.xpath("//small[contains(text(),'Upload a CSV/XLS/XLSX file without header in a for')]")).getText();
							    ...
							    WebElement uploadElement2 = driver.findElement(By.id("lnkUploadDMA"));
							    
							    uploadElement2.click();

							    System.out.println("Uploading a DMA file");	

								
							    //File Need to be imported
								 
							  	File file1 = new File("/Users/soumyak/work/AdTheorent QA_Scripts/DMA/DMA_02");
								...
								driver.findElement(By.cssSelector("#dma > div.row > div.col-sm-2.text-center.multiselect-controls > p:nth-child(2) > a > i")).click();
								...
								Thread.sleep(6000);
								 ...
								 System.out.println("****************************************************************************************");
				    		      ...
				    		      eventFiringWebDriver2.executeScript("document.querySelector('#dmaSelect1').scrollTop = 90000");
				    		      
							      Thread.sleep(3000); 
	
                                 EventFiringWebDriver eventFiringWebDriver4 = new EventFiringWebDriver(driver);
				    		      
				    		      eventFiringWebDriver4.executeScript("document.querySelector('#dmaSelect1').scrollTop = 90000");
				    		      
				    		      Thread.sleep(4000); 
				    		  	
   /*                              EventFiringWebDriver eventFiringWebDriver10 = new EventFiringWebDriver(driver);
				    		      
				    		      eventFiringWebDriver10.executeScript("document.querySelector('#dmaSelect1').scrollTop = 90000");
				    		      
				    		      Thread.sleep(2000); 
					    		  	
                                 EventFiringWebDriver eventFiringWebDriver11 = new EventFiringWebDriver(driver);
				    		      
				    		      eventFiringWebDriver11.executeScript("document.querySelector('#dmaSelect1').scrollTop = 90000"); */
				    		      
							     System.out.println("****************************************************************************************");

									System.out.println("Saving the changes after adding the DMA names from the Available section");
							        ...
							        System.out.println("Successfully navigated to Geography Targeting interface with DMA tab in selected state");
							            
								    System.out.println("****************************************************************************************");
							     
								    System.out.println("Performing search operation in the Chosen section");

						            driver.findElement(By.xpath("//input[@id='dmatxtSearch2']")).clear();

						    	       	    Thread.sleep(2000);

					                driver.findElement(By.xpath("//input[@id='dmatxtSearch2']")).sendKeys(search_city_1);	
...
*/						            
						            ...
						            driver.findElement(By.xpath("//input[@id='dmatxtSearch2']")).sendKeys("\b");
...
/*						            driver.findElement(By.xpath("//input[@id='countrytxtSearch2']")).sendKeys("\b");
						            ...
						            */
									...
									System.out.println("***************************************************************************************"); 
					    		      ...
					    		      eventFiringWebDriver.executeScript("document.querySelector('#dmaSelect').scrollTop = 90000");

								      Thread.sleep(3000); 
								  	
	                                  EventFiringWebDriver eventFiringWebDriver3 = new EventFiringWebDriver(driver);
					    		      
					    		      eventFiringWebDriver3.executeScript("document.querySelector('#dmaSelect').scrollTop = 90000");

					    		      Thread.sleep(4000); 
									  	
/*	                                  EventFiringWebDriver eventFiringWebDriver12 = new EventFiringWebDriver(driver);
					    		      
					    		      eventFiringWebDriver12.executeScript("document.querySelector('#dmaSelect').scrollTop = 90000");
					    		      
					    		      Thread.sleep(2000); 
									  	
	                                  EventFiringWebDriver eventFiringWebDriver13 = new EventFiringWebDriver(driver);
					    		      
					    		      eventFiringWebDriver13.executeScript("document.querySelector('#dmaSelect').scrollTop = 90000");*/	    
											    
											    
								      System.out.println("****************************************************************************************");

										System.out.println("Saving the changes after removing the DMA names from the Chosen section");
							
										Thread.sleep(2000);

										WebElement element101 = driver.findElement(By.xpath("//button[@id='btnSaveGeography' and @type='button']"));
										((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element101);
										...
										String countrysummary5= driver.findElement(By.id("divGeographySummary")).getText();

									    System.out.println("Following system-generated message is being displayed in the GEOGRAPHY section: "+countrysummary5);
				      	    
									    System.out.println("****************************************************************************************");
			 
							      	    Thread.sleep(6000);
							      	    
							              logger.log(LogStatus.PASS, "Test Case Passed is Audience_Builder_UI_DMA_Chosen_No_Data_Append");
			 ...
			 @Test(dataProvider = "Authentication", enabled=true, dependsOnMethods="Audience_Builder_UI_DMA_Chosen_No_Data_Append", priority=3)
			 public void Audience_Builder_UI_DMA_Chosen_With_Data_Append(String sUsername, String sPassword, String audiencename, String search_city_1, String search_city_2,String append, String replace) throws Exception  {  
		    	 		
				 logger = extent.startTest("Audience_Builder_UI_DMA_Chosen_With_Data_Append");		
									    ...
									    System.out.println("Selecting the DMA option from the Geography Targeting interface");
									      ...
									      WebElement ele2 = driver.findElement(By.xpath("//li//a[@onclick='GetDmaData()' and text()='DMA']"));
							            ...
							            driver.findElement(By.xpath("//input[@id='dmatxtSearch1']")).clear();

							    	       	    Thread.sleep(2000);

						                driver.findElement(By.xpath("//input[@id='dmatxtSearch1']")).sendKeys(search_city_2);

					    		        Thread.sleep(4000); 

							            System.out.println("Selecting the DMA names from the Available section");
										...
										builder.keyDown(Keys.SHIFT)
										   .click(driver.findElement(By.xpath("//option[@value='5'][contains(text(),'504 - PHILADELPHIA')]")))
										   .click(driver.findElement(By.xpath("//option[@value='118'][contains(text(),'640 - MEMPHIS')]")))
										   .keyUp(Keys.SHIFT);                
										...
										driver.findElement(By.cssSelector("#dma > div.row > div.col-sm-2.text-center.multiselect-controls > p:nth-child(1) > a:nth-child(1) > i")).click();
										...
										Thread.sleep(6000);
							              ...
							              logger.log(LogStatus.PASS, "Test Case Passed is Audience_Builder_UI_DMA_Chosen_With_Data_Append");
			 ...
			 @Test(dataProvider = "Authentication", enabled=true, dependsOnMethods="Audience_Builder_UI_DMA_Chosen_With_Data_Append", priority=4)
			 public void Audience_Builder_UI_DMA_Chosen_With_Data_Replace(String sUsername, String sPassword, String audiencename, String search_city_1, String search_city_2,String append, String replace) throws Exception  {  
		    	 		
				 logger = extent.startTest("Audience_Builder_UI_DMA_Chosen_With_Data_Replace");	
				 ...
				 Thread.sleep(5000);   
          		...
          		driver.findElement(By.id("dvDMAUploadType")).click();
	    				...
	    				
	    			{
	    				...
	    				if(option4.equalsIgnoreCase(replace))
	    				{
	    					dropdown4.get(i).click();
	    					break;
	    				}
	    			...
	    			Thread.sleep(8000);
                 	...
                 	System.out.println("File Upload has been successful!!!");
										...
										System.out.println("Saving the changes after replacing the DMA names in the Chosen section");
																					
						    			Thread.sleep(6000);

										WebElement element102 = driver.findElement(By.xpath("//button[@id='btnSaveGeography' and @type='button']"));
										((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element102);
							            ...
							            System.out.println("Selecting the DMA names from the Chosen section");
									      ...
									      Thread.sleep(4000); 
											...
											builder2.keyDown(Keys.SHIFT)
											   .click(driver.findElement(By.xpath("//option[@value='49'][contains(text(),'548 - WEST PALM BEACH-FT. PIERCE')]")))
											   .click(driver.findElement(By.xpath("//option[@value='57'][contains(text(),'556 - RICHMOND-PETERSBURG')]")))
											   .keyUp(Keys.SHIFT);                
											...
											driver.findElement(By.cssSelector("#dma > div.row > div.col-sm-2.text-center.multiselect-controls > p:nth-child(1) > a:nth-child(2) > i")).click();		    
									    
											Thread.sleep(7000);
   	    
											System.out.println("****************************************************************************************");

											System.out.println("Clicking on Cancel Changes button after removing the selected DMA names from the Chosen section");
											
											Thread.sleep(2000);

											WebElement element105 = driver.findElement(By.xpath("//button[@value='Geography' and @onclick='ClosePopup(this)']"));
											((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element105);
											...
											String countrysummary6= driver.findElement(By.id("divGeographySummary")).getText();

										    System.out.println("Following system-generated message is being displayed in the GEOGRAPHY section: "+countrysummary6);
					              ...
					              logger.log(LogStatus.PASS, "Test Case Passed is Audience_Builder_UI_DMA_Chosen_With_Data_Replace");
