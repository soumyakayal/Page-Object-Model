...
import com.relevantcodes.extentreports.ExtentReports;
	...
	*/
	...
	public class Audience_Builder_UI_Geography_Targeting_Mosaics extends TestBase{
	...
	System.out.println("Start the 'Audience_Builder_UI_Geography_Targeting_Mosaics' automation script in the UAT platform of the AdTheorent");	

	System.out.println("The objective of the Test is to validate the Audience_Builder_UI_Geography_Targeting_Mosaics section in the Geography Targeting interface");	
	...
	extent = new ExtentReports (System.getProperty("user.dir") +"/test-output/Audience_Builder_UI_Geography_Targeting_Mosaics.html", true);
	...
	public static String getScreenshot(WebDriver driver, String screenshotName) throws Exception {
		...
		return destination;
		  ...
		  public Object[][] credentials() throws BiffException, IOException {
			...
			/* String home = System.getProperty("user.home");
			 File f = new File(FileNameUtils.normalize(home + "/Desktop/Selenium/TestData.xls"));	*/		 
			  ...
			  File f = new File("TestData/Audience_Builder_UI_Mosaics.xls");
		 ...
		 for (int i=1; i<rows; i++){
			 ...
			 public void Navigate_To_Audience_Builder_UI_MANAGE_REAL_TIME_AUDIENCES_panel(String sUsername, String sPassword, String audiencename, String search_mosaic_1, String search_mosaics_2) throws Exception  {  
			 ...
			 public void Audience_Builder_UI_Mosaics(String sUsername, String sPassword, String audiencename, String search_mosaic_1, String search_mosaics_2) throws Exception  {  
		    	 		
				 
				 
				 logger = extent.startTest("Audience_Builder_UI_Mosaics");		
		    		      ...
		    		      Thread.sleep(6000);
							...
							driver.findElement(By.xpath(".//*[@id='divGeographySummary']")).click();
						      ...
						      Thread.sleep(6000); 
					            ...
					            System.out.println("Selecting the Mosaics option from the Geography Targeting interface");


						      WebElement ele = driver.findElement(By.xpath("//li[@id='limosaics']//a[text()='Mosaics']"));
					            ...
					            System.out.println("Successfully navigated to Mosaics interface");
								...
								driver.findElement(By.cssSelector("#mosaics > div > div.col-sm-2.text-center.multiselect-controls > p:nth-child(2) > a > i")).click();
								...
								Thread.sleep(6000);
								 ...
								 System.out.println("****************************************************************************************");
				    		      ...
				    		      eventFiringWebDriver2.executeScript("document.querySelector('#mosaicsSelect1').scrollTop = 90000");
                                ...
                                /* EventFiringWebDriver eventFiringWebDriver4 = new EventFiringWebDriver(driver);
							     ...
							     System.out.println("****************************************************************************************");
									...
									System.out.println("Saving the changes after adding the Mosaic names from the Available section");
					              ...
					              String gettitle222 = driver.getTitle();
									...
									String geosummary1= driver.findElement(By.id("divGeographySummary")).getText();

								    System.out.println("Following system-generated message is being displayed in the GEOGRAPHY section: "+geosummary1);
							        ...
							        System.out.println("Successfully navigated to Geography Targeting interface with Mosaics tab in selected state");
						            ...
						            driver.findElement(By.xpath("//input[@id='mosaicstxtSearch2']")).clear();

						    	       	    Thread.sleep(2000);

					                driver.findElement(By.xpath("//input[@id='mosaicstxtSearch2']")).sendKeys(search_mosaic_1);	
...
*/						            
						            ...
						            driver.findElement(By.xpath("//input[@id='mosaicstxtSearch2']")).sendKeys("\b");
...
/*						            driver.findElement(By.xpath("//input[@id='countrytxtSearch2']")).sendKeys("\b");
									...
									driver.findElement(By.cssSelector("#mosaics > div > div.col-sm-2.text-center.multiselect-controls > p:nth-child(3) > a > i")).click();
									...
									System.out.println("***************************************************************************************"); 
					    		      ...
					    		      eventFiringWebDriver.executeScript("document.querySelector('#mosaicsSelect').scrollTop = 90000");
					    		      ...
					    		      eventFiringWebDriver13.executeScript("document.querySelector('#countrySelect').scrollTop = 90000");	   */ 
										...
										System.out.println("Saving the changes after removing the Mosaic names from the Chosen section");
									    ...
									    System.out.println("Selecting the Mosaics option from the Geography Targeting interface");
									      ...
									      WebElement ele2 = driver.findElement(By.xpath("//li[@id='limosaics']//a[text()='Mosaics']"));
							            ...
							            driver.findElement(By.xpath("//input[@id='mosaicstxtSearch1']")).clear();

							    	       	    Thread.sleep(2000);

						                driver.findElement(By.xpath("//input[@id='mosaicstxtSearch1']")).sendKeys(search_mosaics_2);
					    		      
					    		        Thread.sleep(4000); 

							            System.out.println("Selecting the Mosaic names from the Available section");
										...
										builder.keyDown(Keys.SHIFT)
										   .click(driver.findElement(By.xpath("//option[@value='1'][contains(text(),'A01-American Royalty')]")))
										   .click(driver.findElement(By.xpath("//option[@value='46'][contains(text(),'N46-True Grit Americans')]")))
										   .keyUp(Keys.SHIFT);                
										...
										driver.findElement(By.cssSelector("#mosaics > div > div.col-sm-2.text-center.multiselect-controls > p:nth-child(1) > a:nth-child(1) > i")).click();

									      Thread.sleep(6000); 

										System.out.println("****************************************************************************************");

										System.out.println("Saving the changes after adding the selected Mosaic names from the Available section");
										...
										String geosummary2= driver.findElement(By.id("divGeographySummary")).getText();

									    System.out.println("Following system-generated message is being displayed in the GEOGRAPHY section: "+geosummary2);
							            ...
							            System.out.println("Selecting the Mosaic names from the Chosen section");
									      ...
									      Thread.sleep(4000); 
											...
											driver.findElement(By.cssSelector("#mosaics > div > div.col-sm-2.text-center.multiselect-controls > p:nth-child(1) > a:nth-child(2) > i")).click();		    
											...
											driver.findElement(By.xpath("//button[@id='btnGeographyCancel' and @onclick='ClosePopup(this)']")).click();
					              ...
					              logger.log(LogStatus.PASS, "Test Case Passed is Audience_Builder_UI_Mosaics");
