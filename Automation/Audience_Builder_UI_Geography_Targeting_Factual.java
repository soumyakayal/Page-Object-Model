...
import com.relevantcodes.extentreports.ExtentReports;
	...
	*/
	...
	public class Audience_Builder_UI_Geography_Targeting_Factual extends TestBase{
	...
	System.out.println("Start the 'Audience_Builder_UI_Geography_Targeting_Factual' automation script in the UAT platform of the AdTheorent");	

	System.out.println("The objective of the Test is to validate the Audience_Builder_UI_Geography_Targeting_Factual feature");	
	...
	extent = new ExtentReports (System.getProperty("user.dir") +"/test-output/Audience_Builder_UI_Geography_Targeting_Factual.html", true);
	...
	public static String getScreenshot(WebDriver driver, String screenshotName) throws Exception {
		...
		return destination;
		  ...
		  public Object[][] credentials() throws BiffException, IOException {
			...
			/* String home = System.getProperty("user.home");
			 File f = new File(FileNameUtils.normalize(home + "/Desktop/Selenium/TestData.xls"));	*/		 
			  ...
			  File f = new File("TestData/Audience_Builder_UI_Geography_Targeting_Factual.xls");
		 ...
		 for (int i=1; i<rows; i++){
			 ...
			 public void Navigate_To_Audience_Builder_UI_MANAGE_REAL_TIME_AUDIENCES_panel(String sUsername, String sPassword, String audiencename) throws Exception  {  
			 ...
			 public void Audience_Builder_UI_Geography_Targeting_Factual(String sUsername, String sPassword, String audiencename) throws Exception  {  
		    	 
				 logger = extent.startTest("Audience_Builder_UI_Geography_Targeting_Factual");			
                   ...
                   Thread.sleep(9000);
					...
					driver.findElement(By.xpath(".//*[@id='divGeographySummary']")).click();
				      ...
				      Thread.sleep(6000); 
			            ...
			            System.out.println("Selecting the Factual option from the Geography Targeting interface");


				      WebElement ele = driver.findElement(By.xpath("//li//a[@onclick='GetProximityData()' and text()='Factual']"));
			            ...
			            act.perform();
		    		      ...
		    		      Thread.sleep(8000);   
				            ...
				            System.out.println("Successfully navigated to the Factual page");

				            System.out.println("****************************************************************************************");

    	        			System.out.println("Displaying the Design IDs in the Geopulse Proximity Design ID drop down field");

    		    			WebElement y = driver.findElement(By.id("ddlProximity"));	
    		    			...
    		    			driver.findElement(By.id("ddlProximity")).click();
    		    			...
    		    			System.out.println("Selecting the desired option from Geopulse Proximity Design ID drop down");

    		    			System.out.println("Desired option is being selected from the drop down");
    		    			
    		    			Thread.sleep(4000);
    		    					
    		    			Select datpart1 = new Select(driver.findElement(By.id("ddlProximity")));
    		    			
    		    			datpart1.selectByValue("260");	
    		    			
    		    			System.out.println("Successfully selected the Geopulse Proximity Design ID option from the drop down");
    	        			...
    	        			System.out.println("****************************************************************************************");
				    				...
				    				driver.findElement(By.xpath("//button[@id='btnSaveGeography']")).click();
								    ...
								    System.out.println("****************************************************************************************");
								      ...
								      Thread.sleep(6000); 
								        ...
								        System.out.println("Successfully navigated to Geography Targeting interface with Factual tab in selected state");
								            
									    Thread.sleep(3000); 

										      System.out.println("****************************************************************************************");
							    				
							    				System.out.println("Selecting another Geopulse Proximity Design ID from the drop down list");
					    		    			...
					    		    			Select datpart2 = new Select(driver.findElement(By.id("ddlProximity")));
					    		    			
					    		    			datpart2.selectByValue("186");	
								                ...
								                String gettitle2102 = driver.getTitle();
					     			            try{     

					     			    	    Assert.assertTrue(gettitle2102.contains("Audience"), "Title of the page is not matching");

					     			    	    System.out.println("Title of the page is "+gettitle2102);
					     			    	    
					     			    	    System.out.println("Successfully navigated to Audience page");
					     			            }
					     			            catch (AssertionError e3040) {
					     			            	 System.out.println("Audience page failed to load: "+e3040.getMessage());
											    ...
											    System.out.println("****************************************************************************************");
											      ...
											      Thread.sleep(6000); 
						    		    			...
						    		    			Select datpart3 = new Select(driver.findElement(By.id("ddlProximity")));
						    		    			
						    		    			datpart3.selectByValue("149");	
					                ...
					                //To generate the log when the test case is passed
						              ...
						              logger.log(LogStatus.PASS, "Test Case Passed is Audience_Builder_UI_Geography_Targeting_Factual");  
